...
RouterDC Dataset
----------------
Dataset implementation for RouterDC training and evaluation.

This module provides the RouterDataset class for loading and processing
RouterDC training data.
...
class RouterDataset(Dataset):
    ...
    RouterDataset
    -------------
    Dataset class for RouterDC training and evaluation.
